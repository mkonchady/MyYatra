...
import org.mkonchady.myyatra.USActivity;

public class USActivityTest extends  ActivityInstrumentationTestCase2<USActivity> {
    private Solo solo = null;
    USActivity placeActivity = null;
    private String TAG = "TestUSActivity";

    // calls startUp in CountryActivity
    public USActivityTest() {
        super(USActivity.class);
    }

    public void setUp() throws Exception {
        super.setUp();
        solo = new Solo(this.getInstrumentation(), this.getActivity());
        placeActivity = (USActivity) solo.getCurrentActivity();
    }
    ...
    public void ttestWriteDistance() throws Exception {
        placeActivity.writeDistances(placeActivity.allCities, "us_dist_temp.txt");
    }
