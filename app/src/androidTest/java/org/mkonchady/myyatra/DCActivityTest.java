...
import org.mkonchady.myyatra.DCActivity;
import org.mkonchady.myyatra.PlaceActivity;

public class DCActivityTest extends  ActivityInstrumentationTestCase2<DCActivity> {
    private Solo solo = null;
    DCActivity placeActivity = null;
    private String TAG = "TestDCActivity";

    // calls startUp in CountryActivity
    public DCActivityTest() {
        super(DCActivity.class);
    }

    public void setUp() throws Exception {
        super.setUp();
        solo = new Solo(this.getInstrumentation(), this.getActivity());
        placeActivity = (DCActivity) solo.getCurrentActivity();
        placeActivity.setDISTANCE_IN_METERS(true);
    }
    ...
    public void ttestWriteDistance() throws Exception {
        placeActivity.writeDistances(placeActivity.allCities, "DC_dist_temp.txt");
    }
